...
description: >-
  Ditch the jar! Learn how to make authentic marinara sauce from fresh tomatoes.
  Simple, healthy, and bursting with Mediterranean flavor.
category: food
author: Antigravity
...
recipeYield: 4 cups
recipeIngredient:
  - 3 lbs Ripe Tomatoes (Roma or San Marzano)
...
recipeInstructions:
  - text: >-
      Score the bottom of each tomato with an 'X' and blanch in boiling water
      for 60 seconds.
  ...
  - text: >-
      Add tomatoes and salt. Simmer on low for 45 minutes, breaking the tomatoes
      down with a spoon.
