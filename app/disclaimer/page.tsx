...
export const metadata: Metadata = {
    title: 'Financial Disclaimer | Unstory (unstory.app)',
        ...
        <div className="bg-white dark:bg-zinc-950 min-h-screen">
            <div className="container mx-auto px-4 py-12 max-w-4xl prose prose-blue dark:prose-invert">
                ...
                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 my-6 not-prose">
                    ...
                    <p className="text-yellow-700 text-sm">Unstory (unstory.app) is an educational platform, not a financial advisory firm.</p>
                </div>

                <h2>1. No Financial Advice</h2>
                <p>
                    The information contained on unstory.app is for general information purposes only. The information is provided by Unstory and while we endeavour to keep the information up to date and correct,
